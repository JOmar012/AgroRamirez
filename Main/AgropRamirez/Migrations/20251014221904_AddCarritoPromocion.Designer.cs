...
namespace AgropRamirez.Migrations
{
    ...
    [Migration("20251014221904_AddCarritoPromocion")]
    partial class AddCarritoPromocion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgropRamirez.Models.CarritoPromocion", b =>
                {
                    b.Property<int>("CarritoPromocionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CarritoPromocionId"));
                    ...
                    b.HasKey("CarritoPromocionId");

                    b.HasIndex("CarritoId");

                    b.HasIndex("PromocionId");

                    b.ToTable("CarritoPromociones", (string)null);
                });
            ...
            modelBuilder.Entity("ProductoPromocion", b =>
                {
                    ...
                    b.Property<int>("PromocionesPromocionId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PromocionProductos", (string)null);
                });
            ...
            modelBuilder.Entity("AgropRamirez.Models.CarritoPromocion", b =>
                {
                    b.HasOne("AgropRamirez.Models.Carrito", "Carrito")
                        .WithMany("CarritoPromociones")
                        .HasForeignKey("CarritoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgropRamirez.Models.Promocion", "Promocion")
                        .WithMany()
            ...
            modelBuilder.Entity("ProductoPromocion", b =>
                {
                    b.HasOne("AgropRamirez.Models.Producto", null)
                        .WithMany()
                        .HasForeignKey("ProductosProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgropRamirez.Models.Promocion", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AgropRamirez.Models.Carrito", b =>
                {
                    ...
                    b.Navigation("CarritoPromociones");
                });
